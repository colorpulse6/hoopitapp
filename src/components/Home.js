            ...
            return(
                ...
                <div >
                    ...
                    <div class="container home-container second-font">
                            <h5 class="display-6">Discover games <br></br>around your area</h5>
                            <p class="lead"></p>
                        </div>
                        <div class="container home-container">
                            <h7 class="display-6">Take part in one of the games played near you, get to meet your team for the match of the day </h7>
                            <p class="lead"></p>
                        </div>
                    ...
                    {       //SHUFFLE GAMES AND GET THE FIRST 3
                            this.state.games.sort(() => 0.5 - Math.random()).slice(0,3).map((el, index) => {
                                ...
                                <Link to={this.props.loggedInUser?`/${el._id}/admin`:`/sign-up`}><button className=" card-buttons">View Details</button></Link>
                            </div>
