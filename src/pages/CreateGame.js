        ...
        <div className="create-game-main">
          <form onSubmit={this.props.onAddGame}>
            <div className="form-group">
              <label htmlFor="Date" className="second-font">
                <strong>Choose your date and time</strong>
              </label>
              <hr></hr>
            ...
            <div className="form-group">
              <label htmlFor="location" className="second-font">
                <strong>Location</strong>
              </label>
              <hr></hr>
              {/* <input type="text" className="form-control" name="location" id="location" required/> */}
              <div>
                <SearchCity className="form-control" panTo={this.props.handleLocationInput} />
              </div>
            </div>
            <div className="form-group">
              <label htmlFor="maxPlayers" className="second-font">
                <strong>Pick number of players</strong>
              </label>
              <hr></hr>
              <input
                type="text"
            ...
            <div className="form-group">
              <div className="team-select">
                <label for="team" className="second-font">
                  <strong>Use a Team?</strong>
                </label>
                <hr></hr>
                <select name="team" id="team" className="form-control">
                  <option>No team selected</option>
                  {this.state.teams.map((team, index) => {
                    if (this.props.loggedInUser.username === team.owner) {
                      return (
                        <option key={index} value={team.players}>
                          {team.teamName}
                        </option>
                      );
                    }
            ...
            <button type="submit" className="card-buttons">
              Create <img className="next-button" src={nextButton} alt="Next"></img>
            </button>
          </form>
        </div>
      </div>
